    ...
    return (
      <div className="flex flex-col h-full space-y-5 text-sans select-none">
        ...
        <div className="flex items-center gap-3 pb-3 border-b border-slate-100 dark:border-slate-800">
          <div className="w-10 h-10 rounded-xl bg-indigo-600 text-white flex items-center justify-center font-extrabold text-sm flex-shrink-0 shadow-sm shadow-indigo-500/20">
            {profile.name ? profile.name.charAt(0).toUpperCase() : 'C'}
          </div>
          <div className="min-w-0">
            <h4 className="text-xs font-extrabold text-slate-800 dark:text-white uppercase leading-tight truncate">{profile.name || 'Crix'}</h4>
        ...
        <div className="space-y-1">
          <span className="text-[9px] uppercase font-black tracking-widest text-slate-400 block pb-1">Primary Menu</span>
          ...
          <button
            ...
            className="w-full px-3.5 py-2.5 rounded-xl text-left text-xs font-bold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-all flex items-center gap-2.5 cursor-pointer"
          >
          ...
          >
            ...
            <span className={`text-[9.5px] px-1.5 py-0.5 rounded-full font-bold ${activeTab === 'invoices' ? 'bg-sky-705 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
              {invoices.length}
            </span>
          </button>
          ...
          >
            ...
            <span className={`text-[9.5px] px-1.5 py-0.5 rounded-full font-bold ${activeTab === 'clients' ? 'bg-sky-705 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
              {clients.length}
            </span>
          </button>
        ...
        <div className="space-y-1">
          <button
            ...
            className="w-full flex items-center justify-between text-[10px] uppercase font-black tracking-widest text-slate-400 py-1 cursor-pointer hover:text-slate-600 dark:hover:text-white"
          >
            ...
            <div className="pl-2 space-y-0.5 border-l border-slate-100 dark:border-slate-800 ml-1.5 my-1">
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'master_vendor' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                🏢 Vendor Master
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'master_hsn' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                🔢 HSN Registry
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'master_gl' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                📒 General Ledger
              </button>
          ...
          {isCatalogExpanded && (
            <div className="pl-2 space-y-0.5 border-l border-slate-100 dark:border-slate-800 ml-1.5 my-1">
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'catalog_material' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                🛠️ Material Catalog
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'catalog_category' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                🏷️ Product Category
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'catalog_sub_category' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                📑 Sub-Category
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'catalog_mapping' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                📊 Class Mapping
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'catalog_packing_unit' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                📦 Packing Unit
              </button>
              <button
                ...
                className={`w-full px-3 py-1.5 rounded-lg text-left text-[11px] font-bold transition-all block cursor-pointer ${
                  activeTab === 'catalog_measurement_unit' ? 'bg-sky-600/10 text-sky-600 dark:text-sky-450 font-black font-extrabold' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'
                }`}
              >
                📐 Measurement Unit
              </button>
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 mt-auto">
          {userEmail ? (
            <button
              ...
              className="w-full px-3 py-2 bg-rose-50 dark:bg-rose-950/20 hover:bg-rose-100 dark:hover:bg-rose-955 text-rose-600 dark:text-rose-450 text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer border border-transparent dark:border-rose-900/30 font-extrabold"
            >
            ...
            <button
              ...
              className="w-full px-3 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm font-extrabold"
            >
    ...
    return (
      <div className="space-y-4 text-sans animate-in fade-in duration-205">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800 p-4 rounded-3xl shadow-xs">
          <div>
            <h2 className="text-sm font-black text-slate-800 dark:text-white uppercase tracking-tight flex items-center gap-1.5">
              <span>🗄️ {title}</span>
            </h2>
          ...
          <button
            ...
            className="px-3.5 py-1.5 self-start sm:self-center bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-[10px] font-black tracking-wide flex items-center gap-1 cursor-pointer shadow-md shadow-sky-950/10 animate-bounce"
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800/65 rounded-3xl overflow-hidden shadow-xs">
          {filteredList.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-xs font-bold text-slate-400">No synchronized registry records matching search query</p>
            </div>
          ) : (
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-950/45 border-b border-slate-100 dark:border-slate-800">
                    {columns.map((col, idx) => (
                      <th key={idx} className="p-3 text-[9px] uppercase font-black tracking-wider text-slate-400">{col.header}</th>
                    ))}
                    <th className="p-3 text-[9px] uppercase font-black tracking-wider text-slate-400 text-right">Actions</th>
                  </tr>
                </thead>
                  ...
                  {filteredList.map((item) => (
                    <tr key={item.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-850/20 transition-colors">
                      {columns.map((col, idx2) => (
                        <td key={idx2} className="p-3 text-[11px] font-bold text-slate-700 dark:text-slate-200">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-slate-950/45 backdrop-blur-3xs">
            <div className="w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800 rounded-3xl p-5 space-y-4 shadow-2xl animate-in zoom-in-95 duration-150">
              <div className="flex justify-between items-center pb-2 border-b border-slate-100 dark:border-slate-800">
                <h3 className="text-xs font-black text-slate-800 dark:text-white uppercase tracking-tight">Record Editor</h3>
                <button
                  onClick={() => {
                    setIsMasterModalOpen(false);
                    setEditingMasterItem(null);
              ...
              >
                {fields.map((f, idx3) => (
                  <div key={idx3}>
                    <label className="block text-[8px] font-black uppercase tracking-wider text-slate-400 mb-1">{f.label}</label>
                    {f.type === 'select' ? (
                      <select
                        value={editingMasterItem[f.key] || ''}
                        onChange={(e) => setEditingMasterItem({ ...editingMasterItem, [f.key]: e.target.value })}
                        className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-950 border border-slate-150 dark:border-slate-850 rounded-xl text-[10px] font-bold text-slate-800 dark:text-white focus:outline-none"
                        required
                      >
                ...
                <div className="pt-2 flex justify-end gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-slate-50 hover:bg-slate-100 dark:bg-slate-850 dark:hover:bg-slate-800 text-slate-500 rounded-lg text-[9px] font-extrabold cursor-pointer transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-4 py-1.5 bg-sky-600 hover:bg-sky-500 text-white rounded-lg text-[9px] font-extrabold cursor-pointer transition-all shadow-md shadow-sky-950/10"
                  >
                    Commit Record
                  </button>
                </div>
    ...
    return (
      <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 p-4 rounded-2.5xl shadow-sm text-sans">
        <div className="flex justify-between items-center mb-3">
          <div>
            <span className="text-[10px] text-slate-400 font-extrabold uppercase tracking-wider block">Monthly Billings trend</span>
        ...
        <div className="w-full h-36">
          <svg viewBox={`0 0 ${chartWidth} ${chartHeight}`} className="w-full h-full overflow-visible animate-pulse-subtle">
            ...
            {[0, 0.25, 0.5, 0.75, 1].map((ratio, idx) => {
              ...
              return (
                <g key={idx} className="opacity-40">
                  ...
                  <text x={paddingX - 8} y={y + 3} textAnchor="end" className="text-[8px] font-mono fill-slate-400 font-black">{currencySymbol}{labelValue}</text>
                </g>
              );
            })}
            ...
            {records.map((r, i) => {
              ...
              return (
                <text key={`lbl-${i}`} x={x} y={chartHeight - 4} textAnchor="middle" className="text-[9px] font-black fill-slate-400 font-mono">{r.label}</text>
              );
            })}
          </svg>
        </div>
    ...
    <div className="h-dvh w-full max-w-full overflow-hidden bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 transition-colors duration-200 text-sans">
      ...
      <header className="sticky top-0 z-20 w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-150 dark:border-slate-800/80 px-4 py-3 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-xs font-black text-slate-805 dark:text-white leading-tight max-w-[130px] sm:max-w-[180px] truncate">{profile.name || 'My Invoice Studio'}</h1>
            <span className="text-[9px] text-slate-400 font-bold tracking-wide flex items-center gap-1 mt-0.5">
      ...
      <main className="w-full max-w-[1400px] mx-auto px-3 sm:px-4 pt-4 md:pt-6 space-y-4 md:space-y-0 md:flex md:gap-6 lg:gap-8 md:items-start overflow-hidden">
        ...
        <div className="flex-1 min-w-0 w-full m-0 p-0 h-[calc(100vh-110px)] overflow-y-auto pr-1">
          ...
          {!isOnline && (
            <div className="p-3 mb-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl text-amber-600 dark:text-amber-400 flex items-start gap-2.5 text-xs">
              <WifiOff className="w-4.5 h-4.5 text-amber-500 flex-shrink-0 mt-0.5 font-bold" />
              <div>
                <span className="font-extrabold block">You're Offline (Safe Sandbox Active)</span>
          ...
          <div className="space-y-4">
            ...
            <section className="grid grid-cols-3 gap-2 text-center">
              <div className="bg-white dark:bg-slate-900 p-2.5 rounded-2.5xl border border-slate-100 dark:border-slate-850 shadow-sm">
                <span className="text-[9px] uppercase tracking-wider text-slate-400 font-bold block">Paid Funds</span>
                <span className="text-xs font-black font-mono mt-1 text-emerald-500 block">{currencySymbol}{totalBilled.toLocaleString()}</span>
              </div>
              <div className="bg-white dark:bg-slate-900 p-2.5 rounded-2.5xl border border-slate-100 dark:border-slate-850 shadow-sm">
                <span className="text-[9px] uppercase tracking-wider text-slate-400 font-bold block">Accounts Due</span>
                <span className="text-xs font-black font-mono mt-1 text-amber-500 block">{currencySymbol}{totalOutstanding.toLocaleString()}</span>
              </div>
              <div className="bg-white dark:bg-slate-900 p-2.5 rounded-2.5xl border border-slate-100 dark:border-slate-850 shadow-sm">
                <span className="text-[9px] uppercase tracking-wider text-slate-400 font-bold block">Draft Bills</span>
                <span className="text-xs font-black font-mono mt-1 text-slate-500 block">{currencySymbol}{totalDraft.toLocaleString()}</span>
              </div>
            </section>
            ...
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-bold text-slate-800 dark:text-slate-100">My Invoice Books</h2>
              <button
                onClick={() => onOpenInvoiceEditor(null)}
                className="px-3.5 py-1.5 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-[11px] font-extrabold flex items-center gap-1 cursor-pointer shadow-md shadow-sky-900/15"
              >
            ...
            <div>
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          <div className="flex items-center gap-1">
                            <span className="text-[10px] font-black text-sky-600 font-mono">{inv.invoiceNumber}</span>
                            {(inv.invoiceType || 'invoice') === 'estimate' ? (
                              <span className="bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-400 text-[8px] font-black px-1.5 py-0.5 rounded-full uppercase">
                                Estimate
                              </span>
                            ) : (
                              <span className="bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 text-[8px] font-black px-1.5 py-0.5 rounded-full uppercase">
                                Invoice
                              </span>
                            )}
                            {inv.recurringSettings?.isRecurring && (
                              <span className="bg-sky-100 dark:bg-sky-955 text-sky-650 dark:text-sky-305 text-[8px] font-bold px-1 py-0.5 rounded-md flex items-center gap-0.5">
                                🔄 Repeat {inv.recurringSettings.interval}
                              </span>
                            )}
                            {inv.parentInvoiceId && (
                              <span className="bg-purple-50 dark:bg-purple-950 text-purple-600 dark:text-purple-400 text-[8px] font-bold px-1 py-0.5 rounded-md">
                                Spawned child
                              </span>
                            )}
                          </div>
                          <h4 className="text-xs font-extrabold text-slate-800 dark:text-white mt-1 uppercase line-clamp-1">{inv.clientName || 'Draft Profile'}</h4>
                        ...
                        <div className="text-right">
                          <span className="text-xs font-black font-mono block text-slate-805">{currencySymbol}{inv.grandTotal.toFixed(2)}</span>
                          <span className={`inline-block px-2 mt-1 py-0.5 rounded-full text-[8px] font-black uppercase tracking-wider ${getStatusColor(inv.status)}`}>
                            {inv.status}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="pt-2 border-t border-slate-50 dark:border-slate-800/40 flex items-center justify-between text-[10px] text-slate-400" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-2 py-0.5 bg-sky-50 dark:bg-sky-950/40 text-sky-600 dark:text-sky-400 hover:bg-sky-100 rounded-md text-[9px] font-bold flex items-center gap-0.5 cursor-pointer"
                          >
                          ...
                          <button
                            ...
                            className="px-2 py-0.5 bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 hover:bg-blue-100 rounded-md text-[9px] font-bold flex items-center gap-0.5 cursor-pointer"
                          >
                            Word
                          </button>
                          <button
              ...
              <div className="hidden md:block bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 rounded-2.5xl overflow-hidden shadow-xs">
                <table className="min-w-full divide-y divide-slate-100 dark:divide-slate-800 text-xs">
                  <thead className="bg-slate-50 dark:bg-slate-950 font-bold text-slate-400 text-[10px] uppercase tracking-wider text-left">
                    <tr>
                        ...
                        >
                          ...
                          <td className="px-4 py-3.5">
                            <div className="flex items-center gap-1.5">
                              <span className="font-extrabold font-mono text-sky-600">{inv.invoiceNumber}</span>
                              {(inv.invoiceType || 'invoice') === 'estimate' ? (
                                <span className="bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-400 text-[8px] font-black px-1.5 py-0.5 rounded-full uppercase">Est</span>
                              ) : (
                                <span className="bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 text-[8px] font-black px-1.5 py-0.5 rounded-full uppercase">Inv</span>
                              )}
                              {inv.recurringSettings?.isRecurring && (
                          ...
                          <td className="px-4 py-3.5">
                            <div className="font-extrabold text-slate-800 dark:text-white uppercase truncate max-w-[150px]">{inv.clientName || 'Draft Profile'}</div>
                          ...
                          <td className="px-4 py-3.5 font-mono text-[10px] text-slate-550 dark:text-slate-400">
                            ...
                            <div className="text-rose-500 font-extrabold mt-0.5">Settle: {inv.dueDate}</div>
                          </td>
                          <td className="px-4 py-3.5 font-extrabold font-mono text-slate-805 text-right">
                            {currencySymbol}{inv.grandTotal.toFixed(2)}
                          </td>
                          <td className="px-4 py-3.5 text-center">
                            <span className={`inline-block px-2.5 py-0.5 rounded-full text-[8px] font-black uppercase tracking-wider ${getStatusColor(inv.status)}`}>
                              {inv.status}
                            </span>
                          </td>
                          <td className="px-4 py-3.5 text-right" onClick={(e) => e.stopPropagation()}>
                            <div className="flex items-center justify-end gap-2">
                              <button
                                onClick={() => exportInvoicePDF(inv, profile)}
                                className="px-2 py-1 bg-sky-50 dark:bg-sky-955 text-sky-600 dark:text-sky-400 hover:bg-sky-100 dark:hover:bg-sky-900 rounded-md text-[9px] font-bold flex items-center gap-0.5 cursor-pointer border border-transparent"
                              ...
                              <button
                                onClick={() => handleExportMSWord(inv)}
                                className="px-2 py-1 bg-blue-50 dark:bg-blue-955 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-sky-900 rounded-md text-[9px] font-bold flex items-center gap-0.5 cursor-pointer"
            ...
            {selectedInvoiceIds.length > 0 && (
              <div id="floating-bulk-actions" className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-2xl bg-neutral-950 border border-neutral-800 text-white p-3 md:p-3.5 rounded-2xl shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-3 animate-in slide-in-from-bottom duration-200">
                <div className="flex items-center gap-2">
                  <span className="w-5 h-5 bg-sky-600 rounded-full flex items-center justify-center text-[10px] font-black">{selectedInvoiceIds.length}</span>
                  <span className="text-[11px] font-bold text-slate-200">selected bills</span>
                </div>
                
                <div className="flex flex-wrap items-center justify-center gap-2">
                  <button
                    onClick={handleBulkExportPDF}
                    className="px-2.5 py-1.5 bg-sky-600 hover:bg-sky-500 rounded-xl text-[10px] font-black flex items-center gap-1 cursor-pointer"
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-500 rounded-xl text-[10px] font-black flex items-center gap-1 cursor-pointer"
                  ...
                  <select
                    ...
                    value=""
                    className="px-2 py-1.5 bg-neutral-800 text-white rounded-xl text-[10px] font-black focus:outline-none border border-neutral-750 cursor-pointer"
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-rose-600 hover:bg-rose-500 rounded-xl text-[10px] font-black flex items-center gap-1 cursor-pointer"
        ...
        {activeTab === 'clients' && (
          <div className="space-y-4">
            <div className="flex items-center justify-between bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 p-5 rounded-3xl shadow-sm">
              <div>
                <h2 className="text-sm font-extrabold text-slate-800 dark:text-slate-100">Clients Ledger Book</h2>
              ...
              <button
                ...
                className="px-3 py-1.5 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-[11px] font-extrabold flex items-center gap-1 cursor-pointer shadow-md"
              >
              ...
              {clients.length === 0 ? (
                ...
                clients.map(c => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <h4 className="text-xs font-bold text-slate-800 dark:text-white uppercase">{c.name}</h4>
                        {c.companyName && (
                          <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-550 dark:text-slate-400 font-bold px-1.5 py-0.5 rounded-md mt-0.5 inline-block">
                            🏢 {c.companyName}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-50 dark:border-slate-800/40 text-[9px] font-bold text-slate-500 dark:text-slate-400">
                      <div>
        ...
        {activeTab === 'reports' && (
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 p-5 rounded-3xl shadow-sm">
              <div>
                <h2 className="text-sm font-extrabold text-slate-800 dark:text-slate-100">Accounting Summary</h2>
              ...
              <button
                ...
                className="px-3  py-1.5 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-[10px] font-extrabold flex items-center gap-1 cursor-pointer shadow-md shadow-rose-950/10"
              >
                <Plus className="w-4 h-4" />
            ...
            <section className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 p-3.5 rounded-2.5xl shadow-sm space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label htmlFor="rep-start" className="block text-[8px] font-black uppercase text-slate-400 mb-1">Start Date</label>
                  <input
                    id="rep-start"
                    type="date"
                ...
                <div>
                  <label htmlFor="rep-end" className="block text-[8px] font-black uppercase text-slate-400 mb-1">End Date</label>
                  <input
                    id="rep-end"
                    type="date"
                    value={reportEndDate}
                ...
                <div className="col-span-2">
                  <label htmlFor="rep-client" className="block text-[8px] font-black uppercase text-slate-400 mb-1">Filter by Client Account</label>
                  <select
                    id="rep-client"
                    value={reportClientFilter}
                    onChange={(e) => setReportClientFilter(e.target.value)}
                    className="w-full px-2 py-1.5 bg-slate-50 dark:bg-slate-950 border border-slate-250 dark:border-slate-800 rounded-lg text-[10px] font-semibold text-slate-700 dark:text-white focus:outline-none"
                  >
            ...
            <section className="bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800/85 p-4 rounded-3xl space-y-3.5 shadow-2xs">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-black uppercase tracking-wider text-sky-600 dark:text-sky-405 block font-sans">Collective Invoice Downloader</span>
                ...
                <span className="text-[9px] bg-sky-50 dark:bg-sky-950/40 text-sky-600 dark:text-sky-400 px-2 py-0.5 rounded-lg border border-sky-100 dark:border-sky-900/60 font-mono font-bold">
              ...
              <div className="grid grid-cols-4 gap-1.5">
                <button
                  ...
                  className="px-2 py-1.5 bg-slate-50 hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-850 border border-slate-205 dark:border-slate-800 rounded-xl text-[9px] font-extrabold text-slate-650 dark:text-slate-350 cursor-pointer transition-all"
                >
                  📆 Last 1 Week
                </button>
                <button
                  ...
                  className="px-2 py-1.5 bg-slate-50 hover:bg-slate-100 dark:bg-slate-950 dark:hover:bg-slate-850 border border-slate-205 dark:border-slate-800 rounded-xl text-[9px] font-extrabold text-slate-655 dark:text-slate-350 cursor-pointer transition-all"
                >
                  📅 Last 1 Month
                </button>
                <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-1">
                <button
                  ...
                  className="w-full py-2 bg-sky-600 hover:bg-sky-500 text-white rounded-2xl text-[9.5px] font-extrabold flex items-center justify-center gap-1.5 cursor-pointer shadow-sm transition-all"
                >
                ...
                <button
                  ...
                  className="w-full py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl text-[9.5px] font-extrabold flex items-center justify-center gap-1.5 cursor-pointer shadow-sm transition-all"
                >
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div className="bg-emerald-500/5 dark:bg-emerald-950/15 p-3 rounded-2.5xl border border-emerald-100/40 dark:border-emerald-900/40">
                <span className="text-[9px] uppercase font-black text-slate-400 block tracking-wider">Gross Profit (Received)</span>
                <span className="text-md font-black font-mono text-emerald-600 dark:text-emerald-400 mt-1 block">{currencySymbol}{reportedIncomePaid.toLocaleString()}</span>
                <span className="text-[9px] text-slate-400 font-bold block mt-0.5">From cleared paid checks</span>
              </div>
              
              <div className="bg-rose-500/5 dark:bg-rose-950/15 p-3 rounded-2.5xl border border-rose-100/40 dark:border-rose-900/40">
                <span className="text-[9px] uppercase font-black text-slate-400 block tracking-wider">Business Expenses</span>
                <span className="text-md font-black font-mono text-rose-600 dark:text-rose-400 mt-1 block">{currencySymbol}{totalReportedExpenses.toLocaleString()}</span>
                <span className="text-[9px] text-slate-400 font-bold block mt-0.5">Direct cost overheads</span>
              </div>
              ...
              <div className="col-span-2 bg-sky-500/5 dark:bg-sky-950/15 p-3 rounded-2.5xl border border-sky-100/40 dark:border-sky-900/40 flex justify-between items-center">
                <div>
                  <span className="text-[9px] uppercase font-black text-slate-400 block tracking-wider">Pending Receivables (Unpaid)</span>
                  <span className="text-md font-black font-mono text-amber-600 dark:text-amber-400 mt-1 block">{currencySymbol}{reportedOutstanding.toLocaleString()}</span>
                </div>
                <div className="text-right">
                  <span className="text-[9px] bg-amber-100 dark:bg-amber-950 text-amber-705 dark:text-amber-400 px-2 py-0.5 rounded-lg font-bold">Unsettled Receivables</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 p-4 rounded-2.5xl shadow-sm text-center">
              <span className="text-[10px] text-slate-400 uppercase tracking-widest font-extrabold block">Combined Net Cash Flow Statement</span>
              ...
              {(() => {
                ...
                return (
                  <div className="mt-2 space-y-1">
                    <span className={`text-xl font-black font-mono tracking-tight block ${isProfitable ? 'text-sky-600 dark:text-sky-400' : 'text-rose-500'}`}>
            ...
            <div className="space-y-2">
              <span className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block">Receivables Aging & Pending Bills ({reportedInvoices.filter(i=>i.status==='pending').length})</span>
              {reportedInvoices.filter(i => i.status === 'pending').length === 0 ? (
                <div className="p-3 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-850 rounded-2xl text-center text-[10px] text-slate-400 font-semibold">
                ...
                reportedInvoices.filter(i => i.status === 'pending').map(inv => (
                  ...
                  >
                    <div>
                      <span className="text-[10px] font-black text-amber-600 block">{inv.invoiceNumber}</span>
                      <span className="text-xs font-bold block text-slate-705 dark:text-slate-150 truncate uppercase max-w-[200px]">{inv.clientName}</span>
                    </div>
                    <div className="text-right">
                      <span className="text-xs font-black font-mono block text-slate-805">{currencySymbol}{inv.grandTotal.toFixed(2)}</span>
                      <span className="text-[9px] text-rose-500 font-extrabold block uppercase tracking-wide">Due by: {inv.dueDate}</span>
                    </div>
                  </div>
                ))
              )}
            ...
            <div className="space-y-2">
              <span className="text-[10px] uppercase font-bold tracking-wider text-slate-400 block">Logged Expenditure Ledgers ({reportedExpenses.length})</span>
                ...
                reportedExpenses.map(exp => (
                  ...
                  >
                    <div className="max-w-[250px]">
                      <span className="text-[9px] uppercase font-black text-rose-500 font-mono tracking-tight block">{exp.category}</span>
                      <span className="text-xs font-bold text-slate-805 dark:text-slate-200 block truncate">{exp.description || 'General category expenditure'}</span>
                      <span className="text-[9px] text-slate-400 block font-mono">Charged {exp.date}</span>
                    </div>
                    
                    <div className="text-right flex items-center gap-3">
                      <span className="text-xs font-black font-mono text-slate-805">-{currencySymbol}{exp.amount.toFixed(2)}</span>
                      <button
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-6 text-sans animate-in fade-in duration-200">
            ...
            <div className="space-y-3">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider block">Recent billing records ({invoices.slice(0,3).length})</span>
              {invoices.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.72fr_1.28fr] gap-6">
              ...
              <div className="space-y-4">
                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-wider block">Financial Performance Curve</h3>
        ...
        {activeTab === 'profile' && (
          <div className="space-y-6 text-sans animate-in fade-in duration-200">
            <div className="bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800/80 p-6 rounded-3xl shadow-xs text-center relative overflow-hidden">
              ...
              <h2 className="text-base font-black text-slate-805 uppercase tracking-tight">{profile.name || 'My Invoice Studio'}</h2>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3 text-left">
                <div className="bg-slate-50 dark:bg-slate-950 p-3 rounded-2xl border border-slate-100 dark:border-slate-850">
                  <span className="text-[8px] uppercase font-black text-slate-400 block">LLC Brand Registry</span>
                  <span className="text-[11px] font-extrabold text-slate-800 dark:text-slate-205 mt-1 block truncate">{profile.name || 'Sole Proprietorship'}</span>
                </div>
                <div className="bg-slate-50 dark:bg-slate-950 p-3 rounded-2xl border border-slate-100 dark:border-slate-850">
                  <span className="text-[8px] uppercase font-black text-slate-400 block">Tax Registry (GSTIN)</span>
                  <span className="text-[11px] font-extrabold text-slate-800 dark:text-slate-205 mt-1 block truncate font-mono">{profile.taxId || 'Not Configured'}</span>
                </div>
                <div className="bg-slate-50 dark:bg-slate-950 p-3 rounded-2xl border border-slate-100 dark:border-slate-850">
                  <span className="text-[8px] uppercase font-black text-slate-400 block">Primary currency</span>
                  <span className="text-[11px] font-extrabold text-slate-800 dark:text-slate-205 mt-1 block">{profile.currency || 'INR'} ({currencySymbol})</span>
                </div>
                <div className="bg-slate-50 dark:bg-slate-950 p-3 rounded-2xl border border-slate-100 dark:border-slate-850">
                  <span className="text-[8px] uppercase font-black text-slate-400 block">Mobile Number</span>
                  <span className="text-[11px] font-extrabold text-slate-800 dark:text-slate-205 mt-1 block truncate">{profile.mobile || profile.phone || 'N/A'}</span>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-slate-50 dark:border-slate-850 mt-6">
                <button
                  onClick={onOpenProfile}
                  className="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 text-[10.5px] font-extrabold rounded-xl transition-all cursor-pointer inline-flex items-center gap-1.5"
                >
        ...
        <div className="fixed inset-0 z-50 md:hidden flex">
          ...
          <div className="relative w-64 max-w-[80vw] bg-white dark:bg-slate-900 h-full p-4 shadow-2xl flex flex-col z-10 animate-in slide-in-from-left duration-250 border-r border-slate-100 dark:border-slate-850 overflow-y-auto">
            <div className="flex justify-between items-center mb-5 pb-2 border-b border-slate-100 dark:border-slate-800">
              <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest">Workspace Menu</h3>
              <button
                onClick={() => setIsMobileDrawerOpen(false)}
          ...
          <div className="w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-2xl flex flex-col h-[94vh] max-h-[94vh] border border-slate-200 dark:border-slate-800 animate-in fade-in duration-200">
            ...
            <div className="p-3 px-4 border-b border-slate-100 dark:border-slate-850/80 flex items-center justify-between bg-slate-50 dark:bg-slate-950">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-xs font-black text-slate-805 uppercase leading-none">Live Paper Bill Preview</h3>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-100/50 dark:bg-slate-950/80 no-scrollbar">
              ...
              <div className="p-3 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3 shadow-md">
                <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider text-center">Share & Instant Dispatch Tools</span>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 p-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold cursor-pointer transition-all shadow-sm active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 p-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold cursor-pointer transition-all shadow-sm active:scale-95"
                  >
                    <FileDown className="w-4 h-4" />
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 p-2 bg-emerald-100 text-emerald-800 hover:bg-emerald-250 dark:bg-emerald-950 dark:text-emerald-305 rounded-xl text-xs font-bold cursor-pointer transition-all"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 p-2 bg-teal-100 text-teal-850 hover:bg-teal-200 dark:bg-teal-950 dark:text-teal-300 rounded-xl text-xs font-bold cursor-pointer transition-all"
                  >
                  ...
                  <button
                    ...
                    className="col-span-2 flex items-center justify-center gap-1.5 p-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-805 dark:hover:bg-slate-750 text-slate-800 dark:text-slate-102 rounded-xl text-xs font-bold cursor-pointer transition-all"
                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-slate-900/65 backdrop-blur-sm overflow-y-auto">
          ...
          >
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label htmlFor="cl_fname" className="block text-[10px] font-bold text-slate-400 uppercase">Client Full Name *</label>
                <input
                  id="cl_fname"
                  required
                  type="text"
              ...
              <div>
                <label htmlFor="cl_comp" className="block text-[10px] font-bold text-slate-400 uppercase">Company Name</label>
                <input
                  id="cl_comp"
                  type="text"
                  value={clientCompany}
              ...
              <div>
                <label htmlFor="cl_em" className="block text-[10px] font-bold text-slate-400 uppercase">Client Email Address</label>
                <input
                  id="cl_em"
                  type="email"
                  value={clientEmail}
              ...
              <div>
                <label htmlFor="cl_ph" className="block text-[10px] font-bold text-slate-400 uppercase">Client Phone number</label>
                <input
                  id="cl_ph"
                  type="text"
                  value={clientPhone}
              ...
              <div>
                <label htmlFor="cl_ad" className="block text-[10px] font-bold text-slate-400 uppercase">Billing Address</label>
                <textarea
                  id="cl_ad"
                  value={clientAddress}
            ...
            <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-2.5">
              <button
                type="button"
                onClick={() => setIsClientEditorOpen(false)}
                className="px-3.5 py-1.5 text-xs text-slate-500 font-bold cursor-pointer hover:bg-slate-50"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-4.5 py-1.5 bg-sky-600 text-white font-extrabold text-xs rounded-xl shadow cursor-pointer active:scale-95"
              >
                Save Profile
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-slate-900/65 backdrop-blur-sm overflow-y-auto">
          ...
          >
            <div className="flex justify-between items-center pb-2 border-b border-slate-100 dark:border-slate-805">
              <h3 className="text-xs font-extrabold uppercase tracking-wider text-slate-805">
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label htmlFor="exp_cat" className="block text-[10px] font-bold text-slate-400 uppercase">Expense Category</label>
                <select
                  id="exp_cat"
              ...
              <div>
                <label htmlFor="exp_amt" className="block text-[10px] font-bold text-slate-400 uppercase">Overhead Cost Amount ({currencySymbol}) *</label>
                <input
                  id="exp_amt"
                  required
                  type="number"
              ...
              <div>
                <label htmlFor="exp_dt" className="block text-[10px] font-bold text-slate-400 uppercase">Expenditure Date *</label>
                <input
                  id="exp_dt"
                  required
                  type="date"
              ...
              <div>
                <label htmlFor="exp_desc" className="block text-[10px] font-bold text-slate-400 uppercase">Expenditure Description</label>
                <textarea
                  id="exp_desc"
                  value={expenseDesc}
            ...
            <div className="pt-2 border-t border-slate-100 dark:border-slate-805 flex items-center justify-end gap-2.5">
              <button
                type="button"
                onClick={() => setIsExpenseLoggerOpen(false)}
                className="px-3.5 py-1.5 text-xs text-slate-550 font-bold cursor-pointer hover:bg-slate-5"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-5 py-1.5 bg-rose-600 text-white font-extrabold text-xs rounded-xl shadow cursor-pointer active:scale-95"
              >
                Log Expense
              </button>
            </div>
