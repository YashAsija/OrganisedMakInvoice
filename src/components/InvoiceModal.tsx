      ...
      >
        ...
        <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50 dark:bg-slate-900">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-sm font-bold text-slate-805">
        ...
        <form onSubmit={handleSaveSubmit} className="flex-1 overflow-y-auto p-4 md:p-6 text-sans text-sm pb-8">
          ...
          <div className="bg-slate-50 dark:bg-slate-950 p-3.5 rounded-2xl border border-slate-100 dark:border-slate-900 space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="inv-type" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">Document Type</label>
                <select
                  id="inv-type"
                  value={invoiceType}
                  onChange={(e) => setInvoiceType(e.target.value as 'invoice' | 'estimate')}
                  className="w-full px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 dark:bg-slate-900 dark:text-white font-semibold text-xs focus:ring-1 focus:ring-sky-500 focus:outline-none"
                >
              ...
              <div>
                <label htmlFor="inv-num" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">ID Number</label>
                <input 
                  id="inv-num"
                  type="text" 
                  required
                  ...
                  className="w-full px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 dark:bg-slate-900 dark:text-white font-semibold font-mono text-xs focus:ring-1 focus:ring-sky-500 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 border-t border-slate-150 dark:border-slate-900/50 pt-2.5">
              <div>
                <label htmlFor="inv-ref" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">Ref Number (Optional)</label>
                <input 
                  id="inv-ref"
                  type="text" 
                  placeholder="REF-202"
              ...
              <div>
                <label htmlFor="inv-po" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">P.O. Number (Optional)</label>
                <input 
                  id="inv-po"
                  type="text" 
                  placeholder="PO-883"
            ...
            <div className="grid grid-cols-2 gap-3 border-t border-slate-150 dark:border-slate-900/50 pt-2.5">
              <div>
                <label htmlFor="inv-date" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">Issue Date</label>
                <input 
                  id="inv-date"
                  type="date" 
                  required
              ...
              <div>
                <label htmlFor="inv-duedate" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">Due Date</label>
                <input 
                  id="inv-duedate"
                  type="date" 
                  required
            ...
            <div className="border-t border-slate-150 dark:border-slate-900/50 pt-2.5">
              <label htmlFor="inv-status" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">Status</label>
              <select 
                id="inv-status"
                value={status}
            ...
            <div className="border-t border-slate-150 dark:border-slate-900/50 pt-2.5">
              <label htmlFor="inv-qr" className="block text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-1">Payment link URL (UPI/Venmo/Stripe/PayPal)</label>
              <input 
                id="inv-qr"
                type="text" 
          ...
          {invoiceType !== 'estimate' && (
            ...
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 dark:border-slate-800 pb-1 flex justify-between items-center">
            ...
            {clients && clients.length > 0 && (
              <div className="bg-sky-50/30 dark:bg-slate-950 p-2.5 rounded-2xl border border-sky-100/20 dark:border-slate-800/65">
                <label htmlFor="select-pre-client" className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1">Populate from Clients:</label>
                <select
                  ...
                  className="w-full px-2 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 dark:text-white text-xs font-semibold focus:ring-1 focus:ring-sky-500"
                  defaultValue=""
                >
            ...
            <div className="flex items-center justify-between pt-2">
              <span className="text-[11px] font-bold text-slate-500 uppercase">Shipping details same as client?</span>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-1">
              ...
              <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-lg gap-1">
                <button
                  ...
                  className={`px-3 py-1 text-[10px] font-bold uppercase rounded-md transition-colors ${hasTransport ? 'bg-white dark:bg-slate-700 text-sky-600 dark:text-white shadow-sm' : 'text-slate-500 dark:text-slate-400'}`}
                >
                  Yes
                </button>
                <button
          ...
          <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100/70 dark:border-slate-900 space-y-3">
            <div className="flex items-center justify-between border-b border-slate-150 dark:border-slate-900/50 pb-2">
              ...
              <span className="text-[10px] font-bold text-sky-600 bg-sky-50 dark:bg-sky-950/50 px-2 py-0.5 rounded-md uppercase">
            ...
            <div className="grid grid-cols-2 gap-2.5 pt-1">
              ...
              <div>
                <label htmlFor="tax-cl-country" className="block text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:text-slate-500 mb-1">Client Country</label>
                <select
                  id="tax-cl-country"
              ...
              <div>
                <label htmlFor="tax-cl-state" className="block text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:text-slate-500 mb-1">Client State</label>
                <select
                  id="tax-cl-state"
                  value={(() => {
            ...
            <div className="pt-2.5 border-t border-slate-150 dark:border-slate-800 space-y-2">
              <label className="block text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:text-slate-500">Tax Application Mode</label>
              ...
              {taxMode === 'custom' && (
                <div className="space-y-3 pt-1.5">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label htmlFor="custom-tax-name" className="block text-[9px] font-bold text-slate-400 dark:text-slate-550 uppercase">Tax Label/Name</label>
                      <input
                        id="custom-tax-name"
                        type="text"
                        value={customTaxName}
                    ...
                    <div>
                      <label htmlFor="custom-tax-rate-val" className="block text-[9px] font-bold text-slate-400 dark:text-slate-550 uppercase">Override Rate (%)</label>
                      <input
                  ...
                  <div>
                    <button
                      type="button"
                      className="w-full py-2 rounded-lg border border-dashed border-slate-300 dark:border-slate-700 text-[11px] font-bold text-slate-500 hover:text-sky-600 hover:border-sky-500 hover:bg-sky-50 dark:hover:bg-sky-950/20 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                      ...
                      <div className="space-y-2 mt-3 pt-3 border-t border-slate-100 dark:border-slate-800/50">
                        {additionalTaxes.map((tax, index) => (
                          <div key={tax.id} className="grid grid-cols-2 gap-3 items-end relative group">
                            <div>
                              <label className="block text-[9px] font-bold text-slate-400 dark:text-slate-550 uppercase mb-1">Additional Tax Name</label>
                              <input
                                type="text"
                                value={tax.name}
                                onChange={(e) => {
                            ...
                            <div>
                              <label className="block text-[9px] font-bold text-slate-400 dark:text-slate-550 uppercase mb-1">Rate (%)</label>
          ...
          <div className="space-y-2.5">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 dark:border-slate-800 pb-1">Line Items List ({items.length})</h3>
                  ...
                  >
                    <div className="flex-1 pr-3">
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {item.productType && (
                          <span className="text-[9px] bg-slate-150/60 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-1.5 py-0.5 rounded text-slate-600 dark:text-slate-400 font-semibold">
                        ...
                        {item.discountPercentage !== undefined && item.discountPercentage > 0 && (
                          <span className="text-[9px] bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/60 px-1.5 py-0.5 rounded text-rose-600 dark:text-rose-400 font-bold">
                        ...
                        {item.hsnCode && (
                          <span className="text-[9px] bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/60 px-1.5 py-0.5 rounded text-indigo-700 dark:text-indigo-300 font-bold">
                            HSN: {item.hsnCode}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-2.5">
                      <div className="flex items-center gap-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-1.5 py-1 rounded-xl shadow-sm">
                        <button
                          ...
                          className="w-5 h-5 rounded-md text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 flex items-center justify-center font-bold font-sans cursor-pointer"
                        >
                          -
                        </button>
                        <span className="w-5 text-center text-xs font-bold dark:text-white font-mono">{item.quantity}</span>
                        <button
                          type="button"
                          onClick={() => updateItemQty(item.id, item.quantity + 1)}
                          className="w-5 h-5 rounded-md text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 flex items-center justify-center font-bold font-sans cursor-pointer"
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-950/50 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-3.5 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                <label htmlFor="custom-item-name" className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Product Name *</label>
                <input 
                  id="custom-item-name"
                  type="text" 
                  value={newItemName}
              ...
              {/* SAC & Product Size */}
              <div>
                <label htmlFor="custom-item-hsn" className="block text-[10px] text-slate-500 font-bold uppercase mb-1">HSN Code</label>
                <input 
                  id="custom-item-hsn"
                  type="text" 
              ...
              <div>
                <label htmlFor="custom-item-size" className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Size (Optional)</label>
                <input 
                  id="custom-item-size"
                  type="text" 
                  value={newItemSize}
              ...
              {/* Price / Rate (Required) */}
              <div>
                <label htmlFor="custom-item-rate" className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Rate / Price * ({currencySymbol})</label>
                <input 
                  id="custom-item-rate"
                  type="number" 
                  min="0"
                  ...
                  placeholder="0.00"
                  className="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 dark:text-white font-semibold font-mono text-xs focus:outline-none focus:border-sky-500"
                />
              </div>

              {/* Qty / Amount (Optional, default to 1) */}
              <div>
                <label htmlFor="custom-item-qty" className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Qty & Type (Optional)</label>
                <div className="flex gap-2">
                  <input 
                    ...
                    placeholder="1"
                    className="w-1/2 px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 dark:text-white font-semibold font-mono text-xs focus:outline-none focus:border-sky-500"
                  />
                  <input 
              ...
              <div className="col-span-2">
                <label htmlFor="custom-item-terms" className="block text-[10px] text-slate-500 font-bold uppercase mb-1">Product Terms (Optional)</label>
                <input 
              ...
              {/* Description */}
              <div className="col-span-2">
                <label htmlFor="custom-item-desc" className="block text-[10px] text-slate-400 font-bold uppercase mb-1">Item Description (Optional)</label>
                <input 
                  id="custom-item-desc"
                  type="text" 
                  value={newItemDesc}
            ...
            <button
              ...
              className="w-full py-2.5 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 active:scale-[0.98] cursor-pointer shadow-md shadow-sky-900/20 border-none"
            >
          ...
          <div className="space-y-3 pt-2">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 dark:border-slate-800 pb-1">Tax Adjustments & Discounts</h3>
            ...
            <div className="grid grid-cols-2 gap-3.5 bg-slate-50 dark:bg-slate-950 p-3.5 rounded-2xl border border-slate-50 dark:border-slate-905">
              <div>
                <label htmlFor="discount-type" className="block text-[10px] font-bold text-slate-500 uppercase">Discount Code / Type</label>
                <select 
                  id="discount-type"
                  value={discountType}
                  onChange={(e) => setDiscountType(e.target.value as DiscountType)}
                  className="w-full px-2 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 dark:text-white text-xs font-semibold focus:outline-none"
                >
              ...
              {discountType !== 'none' && (
                <div>
                  <label htmlFor="discount-val" className="block text-[10px] font-bold text-slate-500 uppercase">
                  ...
                  <input 
                    ...
                    placeholder="0"
                    className="w-full px-2 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 dark:text-white font-semibold font-mono text-xs focus:outline-none"
                  />
                </div>
              )}
            </div>
          ...
          <div className="p-3.5 bg-slate-50 dark:bg-slate-950/80 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <span className="block text-xs font-bold text-slate-800 dark:text-slate-200">Recurring Invoice Settings</span>
            ...
            {isRecurring && (
              <div className="space-y-3 pt-2.5 border-t border-slate-100 dark:border-slate-800/65 grid grid-cols-2 gap-3 transition-all duration-300">
                <div className="col-span-1">
                  <label htmlFor="recurring-interval" className="block text-[10px] font-bold text-slate-500 uppercase">Billing Frequency</label>
                  <select
                    id="recurring-interval"
                    value={recurringInterval}
                    onChange={(e) => setRecurringInterval(e.target.value as RecurringInterval)}
                    className="w-full px-2 py-1.5 mt-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 dark:text-white text-xs font-semibold focus:outline-none"
                  >
                ...
                <div className="col-span-1">
                  <label htmlFor="recurring-start" className="block text-[10px] font-bold text-slate-500 uppercase">First Bill Date</label>
                  <input
                    id="recurring-start"
                    type="date"
                ...
                <div className="col-span-2">
                  <label className="block text-[10px] font-bold text-slate-400 uppercase mb-1">Ending Criteria</label>
          ...
          <div>
            <label htmlFor="invoice-notes" className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1">Custom Footnotes / Payment Instructions</label>
            <textarea 
              id="invoice-notes"
              value={notes}
          ...
          <div>
            <label htmlFor="invoice-terms" className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1">Invoice Terms & Conditions (Jurisdictional/MSME)</label>
            <textarea 
              id="invoice-terms"
              value={invoiceTerms}
          ...
          <div className="p-4 bg-sky-50/50 dark:bg-slate-950 text-slate-805 rounded-3xl border border-sky-100/35 dark:border-slate-900 space-y-2.5">
            <span className="block text-xs font-bold uppercase tracking-wider text-sky-700 dark:text-sky-400">Tax Calculator Calculations</span>
            ...
            <div className="space-y-1.5 text-xs">
              ...
              <div className="border-t border-slate-200 dark:border-slate-800 pt-2 flex justify-between font-bold text-slate-805 text-sm">
            ...
            <div className="w-full max-w-[800px] mx-auto bg-white p-8 sm:p-12 shadow-2xl relative text-black text-xs font-sans min-h-[1130px] border border-slate-200">
              <div className="flex justify-between items-start mb-6 border-b border-gray-200 pb-4">
                <div className="w-2/3 flex gap-4 items-stretch">
                  ...
                  <div className="space-y-1">
                    <h1 className="text-xl font-bold uppercase text-gray-900 mb-2">{profile.name || 'Company Name'}</h1>
              ...
              {invoiceType !== 'estimate' && (
                <div className="flex mb-1 border border-gray-300 relative group">
                  <div className="absolute -top-3 right-2 hide-on-print opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1.5 bg-sky-50 border border-sky-200 px-2 py-0.5 rounded-md shadow-sm text-[10px] z-10">
                    <span className="font-semibold text-sky-800">Transport?</span>
                  ...
                  <div className="w-1/2 border-r border-gray-300 p-2.5 space-y-1.5">
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Invoice No.</span><span className="mr-1">:</span> <EditableField value={invoiceNumber} onSave={setInvoiceNumber} className="font-mono text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Dated</span><span className="mr-1">:</span> <EditableField value={date} onSave={setDate} className="font-mono text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Place Of Supply</span><span className="mr-1">:</span> <EditableField value={placeOfSupply} onSave={setPlaceOfSupply} className="text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">GR/RR No.</span><span className="mr-1">:</span> <EditableField value={grRrNo} onSave={setGrRrNo} className="text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Transport</span><span className="mr-1">:</span> <EditableField value={transport} onSave={setTransport} className="text-[11px]" /></div>
                  </div>
                  <div className="w-1/2 p-2.5 space-y-1.5">
                    <div className="flex items-center"><span className="w-28 font-bold text-gray-700">Vehicle No.</span><span className="mr-1">:</span> <EditableField value={vehicleNo} onSave={setVehicleNo} className="text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-28 font-bold text-gray-700">Driver Mobile</span><span className="mr-1">:</span> <EditableField value={driverMobile} onSave={setDriverMobile} className="text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-28 font-bold text-gray-700">Station</span><span className="mr-1">:</span> <EditableField value={station} onSave={setStation} className="text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-28 font-bold text-gray-700">E-Way Bill No.</span><span className="mr-1">:</span> <EditableField value={ewayBillNo} onSave={setEwayBillNo} className="text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-28 font-bold text-gray-700">Purchase Order</span><span className="mr-1">:</span> <EditableField value={poNumber} onSave={setPoNumber} className="text-[11px]" /></div>
                  </div>
                </div>
              )}
              {invoiceType === 'estimate' && (
                <div className="flex mb-1 border border-gray-300">
                  <div className="w-1/2 border-r border-gray-300 p-2.5 space-y-1.5">
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Quote No.</span><span className="mr-1">:</span> <EditableField value={invoiceNumber} onSave={setInvoiceNumber} className="font-mono text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Dated</span><span className="mr-1">:</span> <EditableField value={date} onSave={setDate} className="font-mono text-[11px]" /></div>
                    <div className="flex items-center"><span className="w-24 font-bold text-gray-700">Place Of Supply</span><span className="mr-1">:</span> <EditableField value={placeOfSupply} onSave={setPlaceOfSupply} className="text-[11px]" /></div>
                  </div>
                  <div className="w-1/2 p-2.5 space-y-1.5">
              ...
              <div className="flex mb-6 border border-gray-300">
                <div className="w-1/2 border-r border-gray-300 p-2.5 space-y-1">
                  <h3 className="font-bold text-gray-800 uppercase mb-2">Billed To</h3>
                  <EditableField value={clientName} onSave={setClientName} placeholder="Client Name" className="font-bold text-sm text-gray-900" />
                ...
                <div className="w-1/2 p-2.5 space-y-1 relative group/shipped">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="font-bold text-gray-800 uppercase">Shipped To</h3>
                    <button 
                      type="button" 
                      onClick={() => {
                        setShippedToName(clientName);
                        ...
                        {customTaxCols.map((colName, colIdx) => (
                          <th key={colIdx} className="py-2.5 pl-6 pr-6 border border-gray-300 w-28 text-center bg-slate-800 text-white relative group">
                            ...
                            <EditableField 
                              ...
                              className="text-center font-bold text-white uppercase inline" 
                            /> %
                            <button 
                              type="button" 
                              onClick={() => {
                    ...
                    return (
                      <tr key={item.id} className="align-top hover:bg-slate-50 transition-colors group">
                        ...
                        <td className="py-3 px-3 text-center border-r border-gray-300">
                          <EditableField value={item.name} onSave={(v) => handleUpdateItem(item.id, 'name', v)} className="text-center font-bold text-gray-800 text-[11.5px]" />
                        ...
                        <td className="py-3 px-3 text-center border-r border-gray-300">
                          <div className="flex flex-col items-center gap-0.5">
                            <EditableField value={item.quantity} onSave={(v) => handleUpdateItem(item.id, 'quantity', parseFloat(v) || 0)} type="number" className="text-center font-semibold w-full" />
                        ...
                        <td className="py-3 pl-3 pr-8 text-center font-bold text-gray-900 font-mono relative">
                          {amt.toFixed(2)}
                          <button 
                            type="button" 
              ...
              <div className="flex justify-start mb-6 hide-on-print">
                <button 
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sky-600 hover:bg-sky-50 rounded-lg text-xs font-bold transition-colors border border-sky-100"
                >
              ...
              <div className="flex justify-between items-start pt-2 border-t-2 border-gray-300">
                <div className="w-7/12 pr-6 space-y-4">
                  <div>
                    <span className="font-bold text-gray-800 text-[10px] uppercase block mb-0.5">Notes:</span>
                  ...
                  <div>
                    <span className="font-bold text-gray-800 text-[10px] uppercase block mb-0.5">Banking Information:</span>
                ...
                <div className="w-5/12 space-y-1.5 text-[11px]">
                  ...
                  {taxClassification.type === 'local' ? (
                    ...
                    <div className="flex flex-col border-b border-gray-200 pb-1.5">
                      {customTaxCols.length > 0 ? customTaxCols.map(col => {
                        ...
                        <div className="flex justify-between text-gray-700">
                          <span className="flex items-center gap-2">
                            <EditableField value={customTaxName || 'Tax'} onSave={setCustomTaxName} placeholder="Tax Name" className="w-24 font-bold text-gray-800" />
                          </span>
                          <span className="font-mono">{currencySymbol} {roundedTaxTotal.toFixed(2)}</span>
                        </div>
                      )}
                      ...
                      <div className="mt-1 hide-on-print">
                        <button type="button" onClick={() => setAdditionalTaxes(prev => [...prev, { id: `tax_${Date.now()}`, name: 'Extra Tax', rate: 5 }])} className="text-[10px] text-sky-600 font-bold hover:underline">+ Add Extra Tax</button>
                      </div>
                    </div>
                  )}
                  ...
                  {discountType !== 'none' ? (
                    ...
                    <div className="pt-1.5 pb-1.5 hide-on-print">
                      <button type="button" onClick={() => setDiscountType('flat')} className="text-[10px] text-emerald-600 font-bold hover:underline">
                        + Add Discount
                      </button>
                    </div>
                  )}

                  <div className="flex justify-between font-bold text-[13px] text-gray-900 pt-1.5 border-t border-gray-200">
                    <span>TOTAL</span>
              ...
              <div className="mt-16 flex justify-end">
                <div className="text-center text-gray-400">
                  ...
                  <span className="text-[10px] font-bold text-gray-600 uppercase tracking-wider">Authorized Signatory</span>
                </div>
              </div>
            </div>
          ) : null}
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-end gap-3.5 bg-white dark:bg-slate-900 hide-on-print">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2 rounded-xl text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer"
            >
              Cancel
            </button>
            <button
              ...
              className="px-5 py-2 bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer"
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-md shadow-sky-950/20 active:scale-95 cursor-pointer"
            >
