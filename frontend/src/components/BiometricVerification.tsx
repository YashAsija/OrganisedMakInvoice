        ...
        <AnimatePresence mode="wait">
          {!simulationPrompt ? (
            ...
            >
              ...
              <h1 className="text-xl font-medium tracking-tight">Unlock Bill Maker</h1>
            ...
            >
              ...
              <h2 className="text-lg font-medium">Touch ID / Face ID Authentication</h2>
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-2 mb-4">
        <div className="grid grid-cols-3 gap-3 w-full self-center">
          ...
          <button
            ...
            className="h-14 rounded-xl active:scale-95 text-xs font-medium text-sky-400 hover:text-sky-300 flex items-center justify-center cursor-pointer transition-all"
          >
          ...
          <button
            ...
            className="h-14 rounded-xl active:scale-95 text-xs font-medium text-slate-400 hover:text-white flex items-center justify-center cursor-pointer transition-all"
          >
            Delete
          </button>
        </div>
